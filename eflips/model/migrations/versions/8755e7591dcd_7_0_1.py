...
def upgrade() -> None:
    ...
    sql = "UPDATE \"Area\" SET row_count = 1 WHERE area_type = 'LINE';"
    op.execute(sql)
...
def downgrade() -> None:
    ...
    sql = r"""
    alter table "Area" drop constraint capacity_validity_check;

    alter table "Area" add constraint capacity_validity_check
