...
def upgrade() -> None:
    ...
    op.create_unique_constraint(None, "Depot", ["scenario_id", "station_id"])
    op.create_foreign_key(None, "Depot", "Station", ["station_id"], ["id"])
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, "Depot", type_="foreignkey")
    op.drop_constraint(None, "Depot", type_="unique")
